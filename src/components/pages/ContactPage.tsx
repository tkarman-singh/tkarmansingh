        ...
        <div className="relative w-full max-w-sm bg-white p-8 shadow-sm transform -rotate-2 border border-black/10">
          ...
          <div className="space-y-6 text-2xl">
            ...
            <a href="mailto:t.karman.singh@gmail.com" className="flex items-center gap-4 hover:text-blue-600 transition-colors group">
              ...
              <span className="font-sans text-xl break-all">t.karman.singh@gmail.com</span>
            </a>
            ...
            <div className="flex flex-col gap-4 pt-4 border-t border-dashed border-black/20">
              <a href="https://www.linkedin.com/in/t-karman-singh/" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-blue-600 hover:underline hover:text-blue-800 transition-colors">
                ...
                <span className="font-sans text-xl">t-karman-singh</span>
              </a>
              
              <a href="https://github.com/tkarman-singh" target="_blank" rel="noreferrer" className="flex items-center gap-2 text-gray-800 hover:underline hover:text-black transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                <span className="font-sans text-xl">tkarman-singh</span>
              </a>
            </div>
          </div>
        </div>
