...
const projects = [
  {
    ...
    classes: "left-1/2 -ml-[130px] md:left-[4%] md:ml-0 top-[10px] md:top-[20px] z-[11]",
    color: "bg-[#fdfdfd]",
    rotation: -5,
  },
  {
    ...
    classes: "left-1/2 -ml-[140px] md:left-[26%] md:ml-0 top-[25px] md:top-[5px] z-[12]",
    color: "bg-[#f4f7fe]",
    rotation: 2,
  },
  {
    ...
    classes: "left-1/2 -ml-[120px] md:left-[48%] md:ml-0 top-[40px] md:top-[15px] z-[13]",
    color: "bg-[#e8f5e9]",
    rotation: -3,
  },
  {
    ...
    github: "#",
    classes: "left-1/2 -ml-[130px] md:left-[70%] md:ml-0 top-[55px] md:top-[10px] z-[14]",
    color: "bg-[#fff5e6]",
    rotation: 4,
  }
];
