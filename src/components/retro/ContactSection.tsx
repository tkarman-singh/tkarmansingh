  ...
  return (
    <section className="scroll-mt-[80px] md:scroll-mt-[100px] min-h-screen flex flex-col items-center justify-center py-[90px] px-[24px] md:px-[60px] relative" id="contact-section">
      ...
      <Image 
        ...
        width={300}
        height={300}
        className="absolute bottom-[10%] md:bottom-[20%] right-[5%] md:right-[15%] w-[190px] md:w-[360px] h-auto object-contain pointer-events-none select-none z-0 drop-shadow-sm"
      />
