...
export function ProfileSection() {
  return (
    <div className="min-h-screen flex items-center justify-center py-[90px] px-[24px] md:px-[150px] relative" id="profile-section">
      <span className="absolute top-[40px] left-1/2 -translate-x-1/2 text-[22px] tracking-[.3em] uppercase text-[#6b6a56]">
        01 · about
      </span>
      ...
      <div className="relative w-full max-w-[620px] flex flex-col justify-center pb-[60px]">
        ...
        {/* Content */}
        <div className="relative z-10 text-left w-full flex flex-col pt-[110px] md:pt-[150px] pb-[40px] md:pb-[60px] px-[30px] md:px-[60px]">
