    ...
    <section className="scroll-mt-[80px] md:scroll-mt-[100px] min-h-screen flex flex-col items-center justify-center py-[90px] px-[24px] md:px-[60px] relative" id="tech-stack-section">
      ...
      >
        ...
        <Image 
          ...
          width={150}
          height={150}
          className="absolute -top-[60px] md:-top-[105px] -left-[20px] md:-left-[50px] w-[70px] md:w-[125px] h-auto object-contain pointer-events-none select-none z-[-10] -scale-x-100 drop-shadow-md"
        />
